...
- Report issues and bugs [here](https://github.com/pet-toys/db-assistant-mssql/issues/new?template=bug_report.md).
- Submit feature requests [here](https://github.com/pet-toys/db-assistant-mssql/issues/new?template=feature_request.md).
